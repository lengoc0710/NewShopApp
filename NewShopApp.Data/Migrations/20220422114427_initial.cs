        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnHome = table.Column<int>(nullable: false),
                    ParentID = table.Column<int>(nullable: true),
                    Status = table.Column<int>(nullable: false, defaultValue: 1)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorieTests", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 4, 22, 18, 44, 27, 579, DateTimeKind.Local).AddTicks(4674)),
                    UserId = table.Column<Guid>(nullable: false),
                    ShipName = table.Column<string>(unicode: false, maxLength: 55, nullable: false),
                    ShipAddress = table.Column<string>(unicode: false, maxLength: 55, nullable: false),
                    ShipEmail = table.Column<string>(unicode: false, maxLength: 55, nullable: false),
                    ShipPhoneNumber = table.Column<string>(unicode: false, maxLength: 55, nullable: false),
                    Status = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoAllias = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryTranslations_CategorieTests_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "CategorieTests",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_ProductTests_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_ProductTests_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductTests",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInCategories_CategorieTests_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "CategorieTests",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInCategories_ProductTests_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductTests",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTranslations_ProductTests_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductTests",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
